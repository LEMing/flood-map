export const su: Record<string, string> = {
  ...
  'geo.real': 'nyata',
  'geo.model': 'modél',
  'geo.caveat': 'Luhur ~2 m: taneuh nyata (SoilGrids). Handapeunana: modél régional umum, lain liang bor.',
  'geo.l.topsoil': 'Taneuh luhur (chernozem)',
  'geo.l.subsoil': 'Taneuh handap liat-lempung',
