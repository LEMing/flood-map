...
export const fr: Record<string, string> = {
  ...
  'geo.real': 'réel',
  'geo.model': 'modèle',
  'geo.caveat': "~2 m supérieurs : sol réel (SoilGrids). En dessous : modèle régional généralisé, pas un forage.",
  'geo.l.topsoil': 'Terre végétale (tchernoziom)',
  'geo.l.subsoil': 'Sous-sol argilo-limoneux',
