...
export const gu: Record<string, string> = {
  ...
  'method.body': 'એક શૈક્ષણિક વરસાદ-પૂર સિમ્યુલેશન. પાણીની ભૌતિકશાસ્ત્ર સરળ બનાવેલ છે અને વાસ્તવિક માપ સાથે કેલિબ્રેટ થયેલ નથી, તેથી પૂરની ઊંડાઈ અને વિસ્તાર માત્ર સૂચક છે — પૂર-જોખમ આકારણી નથી. નિકાલ અને જમીન-નુકસાન ખુલ્લા ડેટામાંથી કૃત્રિમ અંદાજ છે, માપેલ મોડેલ નથી; ભૂગર્ભજળ અને નદી કે દરિયાકાંઠાના પૂરનો સમાવેશ થતો નથી. વાવાઝોડાના પ્રીસેટ પ્રતિનિધિ વરસાદ પ્રોફાઇલ છે, માપ રેકોર્ડ નથી.',
