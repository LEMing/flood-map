...
export const gu: Record<string, string> = {
  ...
  'geo.real': 'વાસ્તવિક',
  'geo.model': 'મોડેલ',
  'geo.caveat': 'ઉપરના ~2 m: વાસ્તવિક માટી (SoilGrids). નીચે: સામાન્યીકૃત પ્રાદેશિક મોડેલ, બોરહોલ નહીં.',
  'geo.l.topsoil': 'ઉપરની માટી (ચેર્નોઝેમ)',
  'geo.l.subsoil': 'ચીકણી-ગોરાડુ ઉપમૃદા',
