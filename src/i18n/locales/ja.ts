export const ja: Record<string, string> = {
  ...
  'method.title': '仕組みと限界',
  'method.body': '教育用の降雨洪水シミュレーションです。水の物理は簡略化されており実測値で較正されていないため、浸水の深さや範囲はあくまで目安であり、洪水リスク評価ではありません。排水と土壌損失はオープンデータからの合成推定であり、測量されたモデルではありません。地下水や河川・沿岸の洪水は含まれません。嵐のプリセットは代表的な降雨プロファイルであり、観測記録ではありません。',
