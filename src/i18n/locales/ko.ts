export const ko: Record<string, string> = {
  ...
  'method.body': '교육용 강우 침수 시뮬레이션입니다. 물의 물리는 단순화되어 있고 실제 측정값으로 보정되지 않았으므로 침수 깊이와 범위는 참고용일 뿐이며 홍수 위험 평가가 아닙니다. 배수와 토양 손실은 공개 데이터에서 얻은 합성 추정치이며 측량된 모델이 아닙니다. 지하수와 하천 또는 연안 범람은 포함되지 않습니다. 폭풍 프리셋은 대표적인 강우 프로파일이며 관측 기록이 아닙니다.',
