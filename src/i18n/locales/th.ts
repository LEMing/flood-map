export const th: Record<string, string> = {
  ...
  'method.body': 'การจำลองน้ำท่วมจากฝนเพื่อการศึกษา ฟิสิกส์ของน้ำถูกทำให้ง่ายขึ้นและไม่ได้ปรับเทียบกับการวัดจริง ดังนั้นความลึกและพื้นที่น้ำท่วมจึงเป็นเพียงค่าบ่งชี้เท่านั้น — ไม่ใช่การประเมินความเสี่ยงน้ำท่วม การระบายน้ำและการสูญเสียในดินเป็นการประมาณแบบสังเคราะห์จากข้อมูลเปิด ไม่ใช่แบบจำลองที่สำรวจ น้ำใต้ดินและน้ำท่วมจากแม่น้ำหรือชายฝั่งไม่ได้รวมอยู่ด้วย ค่าตั้งล่วงหน้าของพายุเป็นโปรไฟล์ฝนแบบตัวแทน ไม่ใช่บันทึกจากเครื่องวัด',
