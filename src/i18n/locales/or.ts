...
export const or: Record<string, string> = {
  ...
  'method.body': 'ଏକ ଶିକ୍ଷାମୂଳକ ବର୍ଷା-ବନ୍ୟା ସିମୁଲେସନ୍। ଜଳର ପଦାର୍ଥ ବିଜ୍ଞାନକୁ ସରଳ କରାଯାଇଛି ଏବଂ ପ୍ରକୃତ ମାପ ସହ କ୍ୟାଲିବ୍ରେଟ୍ ହୋଇନାହିଁ, ତେଣୁ ବନ୍ୟାର ଗଭୀରତା ଓ କ୍ଷେତ୍ର କେବଳ ସୂଚକ — ବନ୍ୟା-ବିପଦ ମୂଲ୍ୟାଙ୍କନ ନୁହେଁ। ନିଷ୍କାସନ ଓ ମୃତ୍ତିକା କ୍ଷତି ଖୋଲା ତଥ୍ୟରୁ କୃତ୍ରିମ ଆକଳନ, ସର୍ଭେ ହୋଇଥିବା ମଡେଲ୍ ନୁହେଁ; ଭୂତଳ ଜଳ ଏବଂ ନଦୀ କିମ୍ବା ଉପକୂଳ ବନ୍ୟା ଅନ୍ତର୍ଭୁକ୍ତ ନୁହେଁ। ଝଡ଼ ପ୍ରିସେଟ୍ ପ୍ରତିନିଧିତ୍ୱମୂଳକ ବର୍ଷା ପ୍ରୋଫାଇଲ୍, ମାପ ରେକର୍ଡ ନୁହେଁ।',
