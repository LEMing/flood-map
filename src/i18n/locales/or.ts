...
export const or: Record<string, string> = {
  ...
  'geo.real': 'ବାସ୍ତବ',
  'geo.model': 'ମଡେଲ୍',
  'geo.caveat': 'ଉପର ~2 m: ବାସ୍ତବ ମାଟି (SoilGrids)। ତଳେ: ସାଧାରଣୀକୃତ ଆଞ୍ଚଳିକ ମଡେଲ୍, କୌଣସି ବୋରହୋଲ୍ ନୁହେଁ।',
  'geo.l.topsoil': 'ଉପର ମାଟି (ଚେର୍ନୋଜେମ୍)',
  'geo.l.subsoil': 'ମୃତ୍ତିକା-ଦୋରସା ଅଧଃମାଟି',
