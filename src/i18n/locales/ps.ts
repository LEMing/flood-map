export const ps: Record<string, string> = {
  ...
  'geo.real': 'حقیقي',
  'geo.model': 'ماډل',
  'geo.caveat': 'پاسني ~2 m: حقیقي خاوره (SoilGrids). لاندې: عمومي سیمه‌ییز ماډل، نه د څاه کیندنه.',
  'geo.l.topsoil': 'پاسنۍ خاوره (چرنوزیم)',
  'geo.l.subsoil': 'د خټو-لومي لاندنۍ خاوره',
