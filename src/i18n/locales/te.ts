export const te: Record<string, string> = {
  ...
  'method.body': 'ఒక విద్యా వర్షపు-వరద అనుకరణ. నీటి భౌతికశాస్త్రం సరళీకరించబడింది మరియు వాస్తవ కొలతలతో క్యాలిబ్రేట్ చేయబడలేదు, కాబట్టి వరద లోతులు మరియు ప్రాంతాలు కేవలం సూచనాత్మకం — వరద-ప్రమాద అంచనా కాదు. డ్రైనేజీ మరియు నేల నష్టాలు బహిరంగ డేటా నుండి కృత్రిమ అంచనాలు, సర్వే చేసిన మోడల్ కాదు; భూగర్భ జలం మరియు నది లేదా తీర వరదలు చేర్చబడలేదు. తుఫాను ప్రీసెట్‌లు ప్రాతినిధ్య వర్షపాత ప్రొఫైల్‌లు, కొలత రికార్డులు కాదు.',
