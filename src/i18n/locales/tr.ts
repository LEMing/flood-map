export const tr: Record<string, string> = {
  ...
  'geo.real': 'gerçek',
  'geo.model': 'model',
  'geo.caveat': 'Üst ~2 m: gerçek toprak (SoilGrids). Altta: genelleştirilmiş bölgesel model, sondaj kuyusu değil.',
  'geo.l.topsoil': 'Üst toprak (çernozyom)',
  'geo.l.subsoil': 'Killi-tınlı alt toprak',
