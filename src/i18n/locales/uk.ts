export const uk: Record<string, string> = {
  ...
  'geo.real': 'факт',
  'geo.model': 'модель',
  'geo.caveat': 'Верхні ~2 m — реальні ґрунти (SoilGrids). Глибше — узагальнена регіональна модель, не свердловина.',
  'geo.l.topsoil': 'Ґрунт (чорнозем)',
  'geo.l.subsoil': 'Глинисто-суглинистий підґрунт',
