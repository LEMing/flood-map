export const uk: Record<string, string> = {
  ...
  'method.body': 'Освітня симуляція дощового паводка. Фізика води спрощена і не відкалібрована за реальними вимірами, тому глибини й площі затоплення лише орієнтовні — це не оцінка ризику повені. Дренаж і втрати у ґрунті — синтетичні оцінки за відкритими даними, а не виміряна модель; ґрунтові води та річкові чи прибережні повені не враховуються. Пресети злив — це репрезентативні профілі опадів, а не дані вимірювань.',
